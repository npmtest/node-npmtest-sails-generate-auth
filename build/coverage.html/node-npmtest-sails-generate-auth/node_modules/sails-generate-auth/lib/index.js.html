...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-sails-generate-auth/node_modules/sails-generate-auth/lib/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-sails-generate-auth/node_modules/sails-generate-auth/lib/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-sails-generate-auth/node_modules/sails-generate-auth/lib/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
  targets: {
    './': {
      exec: <span class="fstat-no" title="function not covered" >function (scope, cb) {</span>
<span class="cstat-no" title="statement not covered" >        console.log('Running generator (sails-generate-auth) @ `'+scope.rootPath+'`...');</span>
